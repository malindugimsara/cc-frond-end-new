    ...
    return(
        <header className="w-full h-20 bg-gradient-to-r from-indigo-600 to-purple-600 flex justify-start items-center shadow-xl">
            ...
            <div className="w-full h-full hidden lg:flex justify-evenly items-center px-8 relative">
                ...
                <Link to='/cart'>
                    <BsCart3 className="text-2xl absolute right-[60px] top-1/2 -translate-y-1/2 text-white hover:text-pink-200 transition-all hover:scale-110" />
                </Link>
            </div>
            {
                isOpen &&(
                    <div className="fixed top-0 left-0 w-full h-screen bg-black/50 z-50 flex backdrop-blur-sm lg:hidden">
                        <div className="w-[60%] h-full bg-gradient-to-b from-indigo-100 to-purple-100 flex flex-col pt-8 relative lg:hidden shadow-2xl">
                            <GiHamburgerMenu 
